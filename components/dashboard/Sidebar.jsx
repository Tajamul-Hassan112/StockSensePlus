...
//             <span>Purchases</span>
//           </button> */}
//           <Link href="/purchase" className="flex items-center space-x-2 p-2">
//   <ShoppingBag className="h-4 w-6" />
//   <span>Purchases</span>
// </Link>
...
//           </Link> */}
//           <Link href="/integrations" className="flex items-center p-2 hover:bg-gray-200">
//   <GlobeAltIcon className="h-6 w-6 text-blue-600" />
//   <span className="ml-2">Integrations</span>
// </Link>
//           {/* <Link href="/reports" className="flex items-center space-x-2 p-2">
...
import PublicIcon from '@mui/icons-material/Public'; // Import PublicIcon from @mui/icons-material
import Subscription from "./Subscription";
import SideBarDropDown from "./SideBarDropDown";
    ...
    <div className="w-64 min-h-screen bg-slate-800 text-slate-50 fixed">
      <div className="flex flex-col">
        ...
        <nav className="flex flex-col gap-3 px-3 py-6">
          ...
          <Link href="/integrations" className="flex items-center p-2 hover:bg-gray-200">
            <PublicIcon className="h-6 w-6 text-blue-600" /> {/* Replace with PublicIcon */}
            <span className="ml-2">Integrations</span>
          </Link>
          ...
          <Link href="/documents" className="flex items-center space-x-2 p-2">
            <Files className="h-4 w-6" />
            <span>Documents</span>
          </Link>
        </nav>
